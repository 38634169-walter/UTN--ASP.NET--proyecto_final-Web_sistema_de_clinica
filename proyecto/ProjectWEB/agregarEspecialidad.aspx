...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="d-flex justify-content-center align-items-center">
        <asp:Label class="h1 text-center text-light titulo2 mt-4 mb-5" ID="LabelTitulo" runat="server" Text="Agregar Especialidad"></asp:Label>
    </div>
    ...
    <div class="row">
        ...
        <div class=" col-8 d-flex justify-content-center align-items-center flex-column">
            <asp:Label ID="LabelError" runat="server" Text="" ForeColor="#CC0000"></asp:Label>
             ...
             <asp:TextBox ClientIDMode="Static" CssClass="form-control" ID="TextBoxEspecialidad" runat="server"></asp:TextBox>
