...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="m-auto w-25">
        <div class="m-2 rounded-circle d-flex justify-content-start align-items-center">
            ...
            <asp:TextBox ID="TextBoxDni" runat="server" AutoPostBack="True" OnTextChanged="TextBoxDni_TextChanged"></asp:TextBox>
        ...
        <div class="m-2 rounded-circle d-flex justify-content-start align-items-center">
            ...
            <asp:DropDownList ID="DropEspecialidad" runat="server" OnSelectedIndexChanged="DropEspecialidad_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>
        </div>

        <div class="m-2 rounded-circle d-flex justify-content-start align-items-center">
            <asp:Label ID="LabelPersonal" runat="server" Text="Doctor: "></asp:Label>
            <asp:DropDownList ID="DropPersonalDisponible" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropPersonalDisponible_SelectedIndexChanged"></asp:DropDownList>
        </div>
        <div class="m-2 rounded-circle">
            <asp:Label ID="LabelFecha" runat="server" Text="Fecha: "></asp:Label>
            <asp:TextBox ID="TextBoxfecha" runat="server" TextMode="Date" OnTextChanged="TextBoxfecha_TextChanged" AutoPostBack="True" ></asp:TextBox>   
        </div>
